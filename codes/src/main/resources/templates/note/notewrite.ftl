...
<div class="bgc-w box box-primary">
    ...
    <div class="box-header write">
        ...
        <span style="display:none">
			<a onclick="writecata()">
				<i class="glyphicon glyphicon-edit" style="color:#337ab7"></i>
			</a>

			<a class="cdelete" onclick="cdelete()">
    ...
    <div class="box-body no-padding">
        <div style="padding: 5px;">
            ...
            <div class="btn-group">
                <a class="btn btn-sm btn-default" onclick="somenotedelete()" title="删除">
                    <span class="glyphicon glyphicon-trash"></span>
                </a>

<#--                <a class="btn btn-sm btn-default" title="收藏">-->
<#--                    <span class="glyphicon glyphicon-star-empty choose_collect" data-type="${collect!0}"></span>-->
<#--                </a>-->
            </div>
                ...
                <#if nlist??>
                    <#list nlist as note>
                        <tr>
                            <td>
                                <span class="labels">
                                    <label><input type="checkbox" name="checkbox" id=${note.noteId}><i>✓</i></label>
                                </span>
                            </td>

<#--                            <td>-->
<#--                                <#if note.isCollected==0>-->
<#--                                    <span class="glyphicon glyphicon-star-empty collect" id=${note.noteId}></span>-->
<#--                                </#if>-->
<#--                                <#if note.isCollected==1>-->
<#--                                    <span class="glyphicon glyphicon-star collect" id=${note.noteId}></span>-->
<#--                                </#if>-->
<#--                            </td>-->
                            ...
                            <td><a onclick="notejump('noteedit','${note.noteId}')" class="label xiugai ">
									<span class="glyphicon glyphicon-edit"></span> 修改</a>

                                <a onclick="notejump('noteinfo','${note.noteId}')" class="label xiugai info">
                                    <span class="glyphicon glyphicon-search "></span> 查看</a>

                                <a onclick="{return confirm('删除该记录将不能恢复，确定删除吗？');}" href="notedelete?nid=${note.noteId}" class="label shanchu">
