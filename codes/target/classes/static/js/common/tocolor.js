...
function togrey(){
	/*蓝变灰  */
	$('.blue').removeClass('blue').addClass('grey');
	$('.blue-b').removeClass('blue-b').addClass('grey-g');
	$('.blue-none').removeClass('blue-none').addClass('grey-none');
	$('.blue-left').removeClass('blue-left').addClass('grey-left');
	$('.blue-box').removeClass('blue-box').addClass('grey-box');
	/* 红变灰 */
	$('.red').removeClass('red').addClass('grey');
	$('.red-r').removeClass('red-r').addClass('grey-g');
	$('.red-none').removeClass('red-none').addClass('grey-none');
	$('.red-left').removeClass('red-left').addClass('grey-left');
	$('.red-box').removeClass('red-box').addClass('grey-box');
	/* 黄变灰 */
	$('.yellow').removeClass('yellow').addClass('grey');
	$('.yellow-y').removeClass('yellow-y').addClass('grey-g');
	$('.yellow-none').removeClass('yellow-none').addClass('grey-none');
	$('.yellow-left').removeClass('yellow-left').addClass('grey-left');
	$('.yellow-box').removeClass('yellow-box').addClass('grey-box');
}