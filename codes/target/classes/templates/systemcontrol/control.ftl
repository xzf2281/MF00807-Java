        ...
        <div class="rightcolmd">
            ...
            <div class="panel" style="background-color: white;color: black;">
                ...
                <div class="shrink" style="height: 280px;padding: 10px;">
                    <table cellpadding="2" style="border-collapse: collapse;width:100%;" class="calendar" frame=void
                           id="calendar">
                        <div>
                            ...
                            <div class="yearmonth"
                                 style="text-align:center;width:70%;display:inline;margin-left: 160px;">
                                <div>
                                </div>
                                <tbody>
